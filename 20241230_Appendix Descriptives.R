...
### Figure - Arrange graphs and print ----
...
## Figure 2019 plot EPL and temp empl ----
...
## Figure Transition rates and temporary contracts ----
...
## Figure 2019 plot EPT and temp employment ----
...
EPLI <- read_csv2("EPLI.csv")
EPLI <- EPLI %>% filter(Year >= 2010 & Year <= 2018)
...
plotEPR <- ggplot(data = EPLI_R, aes(x = Year, y=EPLIndex)) +
  ...
  labs(x = "Year", y = "EPL for Open-Ended Contracts (0-6)",
       title = "EPL on OECs evolution in Italy (2010-2018)")+
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank(), axis.line = element_line(colour = "black"),
        text = element_text(family = "serif"), plot.caption=element_text(hjust = 1)) + 
...
plotEPT <- ggplot(data = EPLI_T, aes(x = Year, y=EPLIndex)) +
  ...
  labs(x = "Year", y = "EPL for Fixed-Term Contracts (0-6)",
       title = "EPL on FTCs evolution in Italy (2010-2018)")+
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank(), axis.line = element_line(colour = "black"),
        text = element_text(family = "serif"), plot.caption=element_text(hjust = 1)) +
  scale_y_continuous(limits=c(0, 6))
...
### Arrange and print figure and graphs ----
...
## Graphs for each relevant outcome variable ----
